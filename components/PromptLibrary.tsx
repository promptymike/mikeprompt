...
const LIBRARY: LibraryPrompt[] = [
  ...
  {
    id: 28,
    title: "Odpowiedź na wezwanie z Urzędu Skarbowego",
    description: "Profesjonalna odpowiedź na pismo z US — spokojnie i konkretnie",
    tag: "Any AI",
    category: "Admin & Operations",
    categoryIcon: "📋",
    prompt: `Działaj jako doświadczony doradca podatkowy. Pomóż mi napisać profesjonalną odpowiedź na wezwanie z Urzędu Skarbowego dotyczące [opisz sprawę]. Odpowiedź powinna: 1) Być napisana formalnym językiem urzędowym, 2) Potwierdzić otrzymanie pisma z dnia [data] i numer sprawy [numer], 3) Odnieść się do każdego punktu wezwania, 4) Załączyć wykaz dokumentów które dołączamy, 5) Być uprzejma ale rzeczowa — bez przepraszania jeśli nie ma powodu. Format: oficjalne pismo z nagłówkiem, datą, podpisem. Dane firmy: [nazwa, NIP, adres].`,
  },
  {
    id: 29,
    title: "Prośba o odroczenie płatności ZUS",
    description: "Wniosek o odroczenie terminu płatności składek ZUS",
    tag: "Any AI",
    category: "Admin & Operations",
    categoryIcon: "📋",
    prompt: `Działaj jako specjalista ds. kadr i płac. Napisz formalny wniosek do ZUS o odroczenie terminu płatności składek za [miesiąc/rok]. Powód: [opisz sytuację np. przejściowe problemy z płynnością, opóźnienia od kontrahentów]. Wniosek musi zawierać: 1) Dane płatnika: nazwa firmy, NIP, REGON, adres, 2) Kwotę składek i termin płatności o który wnioskujemy, 3) Uzasadnienie — konkretne i rzeczowe, 4) Propozycję harmonogramu spłaty jeśli dotyczy, 5) Oświadczenie że firma prowadzi działalność i zamierza regulować zobowiązania. Format: oficjalne pismo ZUS, ton formalny.`,
  },
  {
    id: 30,
    title: "Wyjaśnienie błędu w fakturze korygującej",
    description: "Mail do klienta lub US wyjaśniający korektę faktury",
    tag: "Any AI",
    category: "Admin & Operations",
    categoryIcon: "📋",
    prompt: `Działaj jako księgowy z doświadczeniem w komunikacji z klientami. Napisz profesjonalne wyjaśnienie dotyczące faktury korygującej numer [numer] do faktury [numer oryginału] z dnia [data]. Wyjaśnienie powinno: 1) Jasno wskazać co było błędem na oryginalnej fakturze (np. błędna stawka VAT, ilość, cena), 2) Opisać co zostało skorygowane i dlaczego, 3) Podać prawidłowe dane po korekcie, 4) Wskazać różnicę kwotową (do dopłaty/do zwrotu), 5) Przeprosić za niedogodności jednym zdaniem — bez przesady. Odbiorca: [klient biznesowy/Urząd Skarbowy]. Ton: profesjonalny, rzeczowy, pomocny.`,
  },
  {
    id: 31,
    title: "Mail o opóźnieniu faktury do klienta",
    description: "Uprzejme wyjaśnienie opóźnienia w wystawieniu faktury",
    tag: "Any AI",
    category: "Admin & Operations",
    categoryIcon: "📋",
    prompt: `Działaj jako account manager. Napisz uprzejmy mail do klienta [nazwa firmy] wyjaśniający opóźnienie w wystawieniu faktury za [usługa/miesiąc]. Powód opóźnienia: [opisz np. problemy systemowe, reorganizacja działu, choroba]. Mail powinien: 1) Zacząć od przeprosin — krótkich i szczerych, 2) Wyjaśnić powód bez nadmiernych szczegółów, 3) Podać konkretną datę kiedy faktura zostanie wystawiona, 4) Zapewnić że nie wpłynie to na warunki płatności, 5) Zakończyć pozytywnie — docenić współpracę. Ton: profesjonalny ale ciepły. Długość: max 150 słów.`,
  },
  {
    id: 27,
